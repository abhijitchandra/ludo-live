...
- Real-time sync between two browsers using Firebase — works across
  different devices, cities, countries
...
1. One player clicks **Create New Room** and shares the room code (or the
   copied invite link) with the other player.
2. The second player enters the code and clicks **Join Room**.
3. Once both are in, the game begins — Red goes first.
